                        ...
                        <div class="container">
                            <div class="form-field">
                                <dl>
                                    ...
                                    <br>
                                    <dt><span></span>Card Holder's Organization<span class="required">*</span>
                                    </dt>
                                    <dd>
                                        <v-select class="lower_border"
                                                  ...
                                                  @input="setFirstOrganizationName"
                                        />
                                    </dd>
                                    <br>
                                    ...
                                    <dd>
                                        ...
                                        <small id="emailHelp" style="padding-left:260px;" class="form-text text-muted">Size: 220px X 220px</small>
                                    </dd>
                                    <br>
...
<!--                                        <input type="text" name="organization_name">-->
                                    ...
                                    <dd><input type="text" class="lower_border" name="memship_no" v-model="selected_organization_ids" readonly></dd>
                                    <br>
                                    ...
                                    <dd>
                                        <select name="blood_group" class="lower_border">
                                    ...
                                    <dd><input type="text" class="lower_border" name="previous_year_id_card_number"></dd>
                                    <br>
                                ...
                                <div class="first-sign">
                                    ...
                                    <div class="ref7">
                                        <div>
                                            ...
                                            <p>:</p>
<!--                                            <input type="text" class="lower_border" name="caab_id_no">-->
...
<!--                                            <v-select class="lower_border" v-model="form.designation" name="designation"
                                            ...
                                            <input type="text" name="designation" class="lower_border">
                                        </div>
                                        <div style="display: flex;">
                                            <p>Company Name</p>
                                            <p class="ref10">:</p>
...
export default {
    ...
    methods: {
        ...
        setFirstOrganizationName: function(value){
            if(!this.selected_organizations.includes(value))
                this.selected_organizations = [value];
        },
        ...
        submitForm: function () {
            this.errors = [];
            if (!this.member_id) this.errors.push(["member_id", ["Name of the Member Organization required."]]);
            ...
            if (!this.form.card_holder_photograph_attachment) this.errors.push(["card_holder_photograph_attachment", ["Attachment of Card Holder's Photograph required."]]);
            if (!this.form.attachment_file) this.errors.push(["attachment_file", ["Attachment of National ID/Passport/Birth Certificate required."]]);
            if(this.form.card_type == 'Employee'){
                if (!this.form.police_verification_attachment) this.errors.push(["police_verification_attachment", ["Attachment of Police Verification/clearance issue date required."]]);
            }
            if (!this.form.card_holder_signature_attachment) this.errors.push(["card_holder_signature_attachment", ["Signature of Card Holder’s required."]]);
            if (!this.form.signatory_attachment) this.errors.push(["signatory_attachment", ["Signature of Chairman/MD/Director/Managing Partner/Proprietor required."]]);
        ...
        saveIdCard: function () {
            ...
            data.set('status', '0');
            data.set('member_id', this.member_id);
            ...
            axios.post("/api/id_cards", data).then(res => {
                // this.reset();
                // console.log(res.data.id)
                this.success = 'ID Card Saved Successfully';
                this.$router.push({name: "all-id-card", query: {success: this.success}});
            }).catch(error => {
