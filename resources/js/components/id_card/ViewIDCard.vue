    ...
    <div>
        <main id="printMe">
            <div class="container">
                <div class="boxNew">
                    <div class="logoNew">
                        <img :src="addProjectPath('/front/assets/img/id_card/baffa-logo.png')" alt="" width="149">
...
<!--                            <span id="idTwo"></span>-->
                        ...
                        <dd>
                            <span class="lower_border" v-if="form.attachment_file">
                                ...
                                <a style="padding-left: 50px"
                                    :href="assetPath('/'+form.attachment_file)"
                                    target="_blank">See the Attachment </a>
                            </span>
                        ...
                        <dd><span class="lower_border">
                            <span v-if="form.police_verification_attachment">
                                {{form.police_verification | date_format}}
                                <a style="padding-left: 50px" :href="assetPath('/'+form.police_verification_attachment)" target="_blank">
                                See the Attachment
                                </a>
                            </span>
                            <span v-else>{{form.police_verification | date_format}}</span>
                        </span></dd>
                        <br>
...
<!--                </div>-->
                ...
                <div class="signature">
                    ...
                    <div class="d-flex">
                        ...
                        <p v-if="form.company_owner_id">: {{form.company_owner.name}}</p>
                    </div>
                    <div class="d-flex">
                        <p>Designation</p>
