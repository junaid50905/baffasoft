                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                ...
                                <form @submit.prevent="updateMember" role="form" id="registration-form" autocomplete="off" class="mt-3">
                                    ...
                                    <div class="mb-3 ">
                                        <datepicker input-class="form-control"  v-model="form.birth_date" :value="state_date"/>
                                    </div>
                                    <div class="mb-3">
                                        <select class="form-select" aria-label="Default select example" v-model="form.nationality_id">
                ...
                <div class="row">
                    <div class="col-8 mx-auto text-center mt-1">
                        <p class="mb-0 text-secondary small">
                            Copyright © {{today_value}} BAFFA, developed by <a href="http://www.aamrainfotainment.com" class="font-weight-bold" target="_blank"><img :src="addProjectPath('/front/assets/img/aamra.png')"> infotainment ltd.</a>
                        </p>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data(){
        const now = new Date()
        return{
            name: (now.getFullYear() + parseInt(this.$route.params.years)) + '!',
            state_date: new Date(2016, 9,  16),
    ...
    methods: {
        getMembers(){
            axios.
                get('/api/members/edit/' + this.$route.params.id)
                .then(res => {
