        ...
        getGatePass() {
            axios.get('/api/gate_pass/' + this.$route.params.id)
                .then(res => {
                    ...
                    this.formData.date = moment(String(res.data.payment.created_at)).format('YYYY-MM-DD HH:mm:ss');
                        this.formData.receipt_no = res.data.payment.receipt_no;
                        this.formData.member_no = res.data.member_id;
                        this.formData.member_name = res.data.member.username;
                        this.formData.amount = res.data.payment.amount;
                        this.formData.company = res.data.member.organization_name;
