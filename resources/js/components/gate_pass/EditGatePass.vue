<template>
  <div>
      ...
      <div class="card-body">
        <main>
          <div class="container chklist-form">
            ...
            <!--                            </div>-->
            <!--                        </div>-->
            <p class="text-center form-name">EDIT CARGO FORM</p>
            <div class="box2">
              <form
              ...
              >
                ...
                <div class="row">
                  <div class="col-md-5">
                    <!--                                        v-bind:class="[mawb_no > 0 ? 'was-validated' : '','d-flex input1']"-->
                    <div class="d-flex input1">
                      <label for="master_airway_bill_no" id="item-1"
                        >Master Airway bill No.</label
                      >
                      <input
                        type="text"
                        class="form-control"
                        id="master_airway_bill_no"
                        name="master_airway_bill_no"
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-12 mb-3">
                    <label for="member_id"
                      >Name of Shipper/Exporter/Forwarding agent:</label
                    >
                    <v-select
                  ...
                  <div class="col-md-8 mb-3">
                    <div class="d-flex">
                      <label for="shipper_invoice_no" id="item-8"
                        >Shipper’s Invoice No:</label
                      >
                      <input
                        type="text"
                        name="shipper_invoice_no"
                        class="form-control"
                        id="shipper_invoice_no"
                        placeholder=""
                        v-model="form.shipper_invoice_no"
                        required
                      />
                        ...
                        <tbody>
                          <tr>
                            <td>
                              ...
                              <input
                                id="cargo_bound_for_a"
                                name="cargo_bound_for"
                                v-model="form.cargo_bound_for"
                                type="radio"
                                value="EU"
                              />
                            </td>
                    ...
                    <i>
                      ...
                      <div class="form-group">
                        ...
                        <v-select
                          ...
                          :reduce="(members) => members.id"
                          label="organization_name"
                          id="on_behalf_of_member_id"
                          name="on_behalf_of_member_id"
                        ></v-select>
                      </div>

                      I, the undersigned, hereby declare that the contents of this
                      consignment do not contain any prohibited or illicit items and I am
                      satisfied that the contents are as stated and safe for air carriage.
                      The goods have been secured and protected during all stages of
                      storage and transportation. I understand that a false declaration
                      could lead to legal action being taken.</i
                    >
                  </p>
                  <p class="text5">Signature<input />Date<input /></p>
                  <p class="text6">
                    Name (Shipper/Agent)<input
                      name="agent_name"
                      type="text"
                      v-model="form.agent_name"
                    />ID No.<input name="agent_id_no" v-model="form.agent_id_no" />
                  </p>
                </div>
                <div class="box5 pt-3">
                  <div class="d-flex">
                    ...
                    <p>
                      Vehicle No.
                      <input type="text" name="vehicle_no" v-model="form.vehicle_no" />
                      Date of entry:
                      <input
                        type="date"
                        name="vehicle_date_of_entry"
                        v-model="form.vehicle_date_of_entry"
                      />
                      Time of entry
                      <input
                        type="time"
                        name="vehicle_time_of_entry"
                        ...
                        <tbody>
                          <tr>
                            <td>
                              ...
                              <input
                                id="Unknown"
                                name="accepted_of_cargo"
                                value="Unknown"
                                v-model="form.accepted_of_cargo"
                                type="radio"
                              />
                            </td>
                            <td>
                ...
                <div class="box9">
                  <p class="text8">
                    c) Visual Inspection of Consignment During Acceptance:
                  </p>
                  <div class="pl-4">
                    ...
                    <p>
                      iv. Boxed/packed with extra jacket; to a degree which could have
                      allowed the introduction of a prohibited article.
                    </p>
                  </div>
                </div>
                <div class="box10">
                  ...
                  <p class="text12">
                    Dimension (i)<input
                      type="text"
                      name="dimensioni"
                      v-model="form.dimensioni"
                    />
                    (ii)<input
                      type="text"
                      name="dimensionii"
                      v-model="form.dimensionii"
                    />
                    (iii)<input
                      type="text"
                      name="dimensioniii"
                      v-model="form.dimensioniii"
                    />
                  </p>
                  <p class="text13">
                    (iv)<input
                      type="text"
                      name="dimensioniv"
                      v-model="form.dimensioniv"
                    />
                    (V)<input type="text" name="dimensionv" v-model="form.dimensionv" />
                    (Vi)<input
                      type="text"
                      name="dimensionvi"
                      v-model="form.dimensionvi"
                    />
                  </p>
                  <p class="text14">
                    Volumetric Weight of Entire Goods<input
                      type="text"
                      name="vwt"
                      v-model="form.vwt"
                    />
                    CBM<input type="text" name="cbm" v-model="form.cbm" /> Chargeable
                    Weight<input
                      type="text"
                ...
                <div class="bottom-sign">
                  <div class="d-flex">
                    <div class="d-flex flex-column">
                      ...
                      <p>
                        Signature of Shipper/Agent/Airline<br />
                        Representative with Name and ID No.<input />
                      </p>
                    </div>
                    <div class="d-flex flex-column">
                      <input style="width: 185px" />
                      <p>
                        Signature of Acceptance Staff with<br />
                        Name and Staff No.<input />
                      </p>
                    </div>
                    <div class="d-flex flex-column">
                      <input style="width: 185px" />
                      <p>
                        Signature of Security personnel with<br />
                        Name and Staff No.<input />
                      </p>
                    </div>
                    <div class="d-flex flex-column">
                      <input />
                      <p>
                        Signature of Duty Officer with<br />
                        Name and Staff No.<input />
                      </p>
                    </div>
                  </div>
                ...
                <div class="box11">
                  <div class="d-flex">
                    <p class="text16">
                      <i
                        >Distribution: Copy-1 Biman, Copy-2 CAAB, Copy-3 Agent, Copy-4
                        Shipper.</i
                      >
                    </p>
                  ...
                  <div class="d-grid gap-2 col mx-auto pt-3">
                    ...
                    >
                      ...
                      <div
                        ...
                        v-bind:style="{
                          backgroundImage:
                            'url(' + addProjectPath('/assets/img/ajax-loader.gif') + ')',
                        }"
                      ></div>
                    </button>
                  </div>
    ...
    <link
      type="text/css"
      rel="stylesheet"
      :href="addProjectPath('/front/assets/css/style.css')"
    />
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    if (window.Laravel.isLoggedin) {
      ...
      this.selected_id_no = parseInt(this.$route.params.id);
      this.getGatePass();
  ...
  methods: {
    ...
    checkUnique(value) {
      ...
      if (/^([0-9]+)$/.test(mawb)) {
        if (/^([0-9]{11})$/.test(mawb)) {
          ...
          axios
            .get(
              "/api/check_mawb_gate_pass?mawb=" + mawb + "&id=" + this.$route.params.id
            )
            .then((res) => {
    ...
    getGatePass() {
      axios
        ...
        .then((res) => {
          this.form = res.data;
          this.openingBalance = res.data.member.gatepass_balance;
          this.selected_member_id = res.data.member.id;
          // this.selected_id_no = res.data.id
          if (this.form.payments.length) {
            this.is_new_payment = false;
          ...
          if (this.form.vehicle_date_of_entry)
            this.form.vehicle_date_of_entry = new Date(res.data.vehicle_date_of_entry)
              .toISOString()
              .slice(0, 10);
          ...
          if (this.form.weight_taken_date_time)
            this.form.weight_taken_date_time = moment(
              String(this.form.weight_taken_date_time)
    ...
    submitForm: function () {
      ...
      if (!this.validation)
        this.errors.push([
          "master_airway_bill",
          ["MAWB No. Must be 11 Digit & Numeric value."],
        ]);
      if (!this.form.master_airway_bill_no)
        this.errors.push(["master_airway_bill_no", ["Bill No. required."]]);
      if (!this.form.member_id)
        this.errors.push([
          "member_id",
          ["Name of Shipper/Exporter/Forwarding agent required."],
        ]);
      if (!this.form.on_behalf_of_member_id)
        this.errors.push(["on_behalf_of_member_id", ["On Behalf OF required."]]);
      ...
      if (!this.form.destination)
        this.errors.push(["destination", ["Destination. required."]]);
    ...
    updateGatePass: function (done) {
      ...
      if (this.form.vehicle_date_of_entry)
        data.set(
          ...
          moment(String(this.form.vehicle_date_of_entry)).format("YYYY-MM-DD")
        );
      if (this.form.vehicle_time_of_entry)
        data.set(
          "vehicle_time_of_entry",
          moment(String(this.form.vehicle_time_of_entry), "hh:mm A").format("HH:mm:ss")
        );
      if (this.form.weight_taken_date_time)
        data.set(
          "weight_taken_date_time",
          moment(String(this.form.weight_taken_date_time)).format("YYYY-MM-DD HH:mm:ss")
        );
      ...
      axios
        .post("/api/gate_pass/" + this.$route.params.id + "/update", data)
        .then((res) => {
