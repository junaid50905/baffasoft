                    ...
                    <div class="card-body">
                        <table class="table mt-5">
                            ...
                            <tr v-for="(company_owner,i) in company_owners">
                                ...
                                <td>
                    <span v-if="!company_owner.is_deleted">
                        <span v-if="checkAccess('edit_company_owner')">
                            <button class="btn btn-icon" @click="editOwner(company_owner)"><i
                                class="fa fa-edit"></i></button>
                        </span>
                        <span v-if="checkAccess('delete_company_owner')">
                            <button class="btn btn-icon" @click="deleteMember(company_owner.id)">
...
export default {
    ...
    methods: {
        ...
        getCompanyOwners() {
            axios
                .get('/api/members/' + this.$route.params.id + '/deleted_company_owners')
                .then(res => {
