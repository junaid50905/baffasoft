    ...
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <div class="voter-form">
                        <form class="needs-validation"
                            ...
                            <div class="form-group row">
                                <label for="other_training_name" class="col-sm-3 col-form-label"
                                >Other Training Name:
                                </label>
                                <div class="col-sm-8">
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="other_training_name"
                                        name="other_training_name"
                                        v-model="form.other_training_name"
                                        placeholder="Other Training Name"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="ParticipantTel" class="col-sm-3 col-form-label"> Tel No.</label>
                                <div class="col-sm-3">
                                    <input
                                        type="number"
                                        class="form-control"
                                        id="ParticipantTel"
                                        name="participant_tel"
                                        v-model="form.participant_tel"
                                        placeholder="Participant Tel No"
                                    />
                                </div>

                                <label for="ParticipantMobile" class="col-sm-2 col-form-label">
                                    Mobile.</label
                                >
                                <div class="col-sm-3">
                                    <input
            ...
            <div class="card" v-else>
                <div class="card-header text-center">
                    <h2>Other Training is Disabled</h2>
                </div>
        ...
        saveGatePass: function () {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (!this.is_member)
                        this.$router.push({
                            name: "all-other-training",
                            query: {success: this.success},
                        });
                    else
                        this.$router.push({
                            name: "all-other-training_member",
                            query: {success: this.success},
                        });
