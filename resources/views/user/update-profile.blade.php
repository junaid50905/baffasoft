                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="50" name="house_rent_allowance">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="20" name="medical_allowance">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">% of Basic Salary</div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="10" name="conveyance">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">% of Basic Salary</div>
                                        </div>
                                    </div>
                        ...
                        <fieldset class="border p-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" value="7" name="provident_fund">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">% of Basic Salary</div>
                                        </div>
                                    </div>
