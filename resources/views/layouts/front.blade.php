...
{{--    @include('partials.frontsidebar')--}}
{{--    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">--}}
        <!-- Navbar -->
        @include('partials.frontbreadcrumb')
...
{{--    </main>--}}
    ...
    {!! HTML::script('front/assets/js/core/popper.min.js') !!}
    ...
    {!! HTML::script('front/assets/js/plugins/chartjs.min.js') !!}
{{--    <script>--}}
...
{{--    </script>--}}
    ...
    {!! HTML::script('front/assets/js/soft-ui-dashboard.js?v=1.0.3',['defer']) !!}
    @yield('scripts')
    @hook('member:scripts')
</body>
