...
use Vanguard\Repositories\MemberDetail\EloquentMemberDetail;
...
use Vanguard\Repositories\Member\EloquentMember;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(MemberDetailRepository::class, EloquentMemberDetail::class);
        $this->app->singleton(CountryRepository::class, EloquentCountry::class);
        $this->app->singleton(ActivityRepository::class, EloquentActivity::class);
        $this->app->singleton(MemberRepository::class, EloquentMember::class);
