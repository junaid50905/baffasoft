...
class UsersController extends Controller
{
     ...
     */
    public function __construct(UserRepository $users,MemberRepository $members)
    {
        $this->users = $users;
    ...
    public function memberList(Request $request)
        {
            ...
            $users = $this->members->paginate($perPage = 20, $request->search, $request->status);

            $statuses = ['' => __('All')] + MemberStatus::lists();
