...
class UsersController extends ApiController
{
    ...
    {
        $this->middleware('permission:users.manage')->except('userList');
...
//  http://localhost/baffasoft/api/all_users?include=country&filter[search]=Baff
    public function userList()
    {
        return User::whereNotNull('username')->get(['username','id']);
    }
