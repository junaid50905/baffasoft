...
class AuthController extends ApiController
{
    ...
    public function member_token(ApiLoginRequest $request)
    {
        $user = $this->findMember($request);
    ...
    private function findMember(ApiLoginRequest $request)
    {
        $user = Member::where($request->getCredentials())->first();
